...
class ServiceCallbacks(Service):
    ...
    def cb_create(self, tctx, root, service, proplist):
        ...
        self.log.info('starting to configure vpn-id:', service.vpn_name)

        for link in service.link:
           tvars = ncs.template.Variables()
           template = ncs.template.Template(service)

           self.log.info('starting to configure link-id:', link.link_name)
           self.log.info('starting to configure interface:', link.link_name)
